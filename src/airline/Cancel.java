...
public class Cancel extends JFrame { //Sixth
	...
	Cancellation.setFont(new Font("Times New Roman", Font.PLAIN, 31));
	...
	PassengerNo.setFont(new Font("Times New Roman", Font.PLAIN, 17));
	PassengerNo.setBounds(60, 100, 132, 26);
	add(PassengerNo);
		
	JLabel CancellationNo = new JLabel("CANCELLATION NO");
	CancellationNo.setFont(new Font("Times New Roman", Font.PLAIN, 17));
	CancellationNo.setBounds(60, 150, 150, 27);
	add(CancellationNo);
		
	JLabel CancellationDate = new JLabel("CANCELLATION DATE");
	CancellationDate.setFont(new Font("Times New Roman", Font.PLAIN, 17));

...
public class Payment_Details extends JFrame{ //Fifth
	...
	Sector.setFont(new Font("Times New Roman", Font.PLAIN, 31));
	Sector.setBounds(51, 17, 300, 39);
	add(Sector);
		
	FlightCode = new JLabel("PNR_NO");
	FlightCode.setFont(new Font("Times New Roman", Font.PLAIN, 13));
	...
	Cardno.setFont(new Font("Times New Roman", Font.PLAIN, 13));
	Cardno.setBounds(602, 299, 101, 19);
	add(Cardno);
		
	JLabel Phoneno = new JLabel("PHONE_NO");
	Phoneno.setFont(new Font("Times New Roman", Font.PLAIN, 13));
